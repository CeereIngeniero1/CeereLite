...
BEGIN TRY
    ...
    PRINT 'Columna [Id Plan de Tratamiento] agregada exitosamente a la tabla [Evaluación Entidad Rips].';
END TRY
BEGIN CATCH
    PRINT 'Error al agregar la columna [Id Plan de Tratamiento]: ' + ERROR_MESSAGE();
END CATCH;
GO
...
CREATE TABLE CredencialesWSDLFacturaTech (
	...
	PRINT 'Tabla para credenciales WSDLFacturaTech creada correctamente!';
END TRY
BEGIN CATCH
	PRINT 'Error al crear Tabla para credenciales WSDLFacturaTec: ' + ERROR_MESSAGE();
END CATCH;
GO
